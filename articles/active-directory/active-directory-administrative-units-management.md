...
> [!IMPORTANT]
> To use administrative units requires an Azure AD Premium license for the Administrative Unit-scoped admin, and Azure AD Basic licenses for all users in the Administrative Unit. For more information, see [Getting started with Azure AD Premium](active-directory-get-started-premium.md).
>
